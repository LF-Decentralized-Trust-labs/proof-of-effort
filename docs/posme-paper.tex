...
\addplot[fill=blue!60] coordinates {(DDR5,45) (HBM3,20)};
\addlegendentry{Memory latency}
\addplot[fill=red!60] coordinates {(DDR5,3) (HBM3,0.3)};
\addlegendentry{Hash (BLAKE3)}
\end{axis}
\end{tikzpicture}
\caption{Per-read cost breakdown. Hash is $< 7\%$ on DDR5 (45\,ns
measured average) and negligible on HBM3. Memory latency dominates.}
