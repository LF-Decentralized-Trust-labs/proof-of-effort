...
VDFs~\cite{boneh2018vdf} prove sequential time but not
memory-hardness. PoSW~\cite{cohen2018posw} operates over static
graphs. Argon2id~\cite{biryukov2016} is memory-hard but offers no
chain proof system. Composing these yields independent properties
that do not reinforce each other.

\posme{} fuses them: a persistent mutable arena \emph{is} the
