...
\node[right=0.2cm of hash1, font=\footnotesize] (dots) {$\cdots$};
...
\node[below=0.6cm of read0, font=\scriptsize, text width=1.8cm,
      align=center] {addr depends\\on cursor};
\node[below=0.6cm of hash0, font=\scriptsize, text width=1.8cm,
      align=center] {cursor depends\\on block};
\end{tikzpicture}
