...
| -------------------------- | ------------------------------------------------------------ |
| Attester                   | CPoE client (CLI, native app, browser extension)             |
| Evidence                   | Evidence Packet (CBOR tag `1129336645` / `CPoE`)             |
...
| -------------------------- | ------------------------------------------------------------ |
| draft-ietf-rats-eat        | EAT profile URI: `urn:ietf:params:rats:eat:profile:cpoe:1.0` |
